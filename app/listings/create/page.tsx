...
import { generateAIDescriptionAction } from "./actions";
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5 pl-1">
                ...
                {/* ADVANCED AI MAGIC BUTTON WRAPPER */}
                <button
                  type="button"
                  disabled={aiLoading}
            ...
            >
              ...
              {loading ? "Synchronizing..." : "Publish Advertisement"}
            </button>
          </form>
        </main>
      </div>
